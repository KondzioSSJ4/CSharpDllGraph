...
Script path:
`./.agents/skills/plan-output-script/scripts/execute-plan.ps1`

Example:
`pwsh ./.agents/skills/plan-output-script/scripts/execute-plan.ps1 -Plan phase-06-mcp-tools -Provider codex -Model gpt-5.4`
